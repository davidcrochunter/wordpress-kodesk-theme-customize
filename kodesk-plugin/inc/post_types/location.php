 ...
 * @author   Wptech
 */
class Location extends Post_Type {
	...
	public static function init() {
		...
		self::instance()->menu_name = esc_html__( 'Location', 'kodesk' );
		self::instance()->singular  = esc_html__( 'Location', 'kodesk' );
		self::instance()->plural    = esc_html__( 'Location', 'kodesk' );
