 ...
 * @since 1.0.0
 */
class Gallery_2_Column extends Widget_Base {
    ...
    public function get_name() {
        return 'kodesk_gallery_2_column';
    }
    ...
    public function get_title() {
        return esc_html__('Gallery 2 Column', 'kodesk');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'gallery_2_column',
            [
                'label' => esc_html__('Gallery 2 Column', 'kodesk'),
            ]
        );
        $this->add_control(
            'number',
                ...
                foreach( (array)$post_terms as $pos_term )
					...
					if($post_terms)
						foreach($post_terms as $p_term)
							...
							<div class="col-lg-6 col-md-6 col-sm-12 masonry-item small-column all <?php echo esc_attr($term_slug); ?>">
                                <div class="project-block-two">
                                    <div class="inner-box">
                                        <figure class="image-box"><a href="<?php echo esc_url($post_thumbnail_url); ?>"><?php the_post_thumbnail('kodesk_570x430'); ?></a></figure>
                                    </div>
                                </div>
                            </div>
