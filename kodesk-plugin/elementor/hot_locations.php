 ...
 * @since 1.0.0
 */
class Hot_Locations extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Hot Locations', 'kodesk' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'hot_locations',
            [
                'label' => esc_html__( 'Hot Locations', 'kodesk' ),
            ]
        );
        $this->add_control(
            'image',
            ...
            <div class="auto-container">
                <div class="row clearfix align-items-center">
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <figure class="image-box"><img src="<?php echo esc_url(wp_get_attachment_url($settings['image']['id'])); ?>" alt="<?php esc_html_e('Awesome Image', 'kodesk'); ?>"></figure>
                    </div>
                        ...
                        <div class="content-box">
                            ...
                            <div class="inner-box">
                                ...
                                <div class="single-item">
                                    <div class="icon-box"><i class="flaticon-diagonal-arrow"></i></div>
