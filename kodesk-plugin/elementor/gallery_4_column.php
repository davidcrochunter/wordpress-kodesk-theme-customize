 ...
 * @since 1.0.0
 */
class Gallery_4_Column extends Widget_Base {
    ...
    public function get_name() {
        return 'kodesk_gallery_4_column';
    }
    ...
    public function get_title() {
        return esc_html__('Gallery 4 Column', 'kodesk');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'gallery_4_column',
            [
                'label' => esc_html__('Gallery 4 Column', 'kodesk'),
            ]
        );
        $this->add_control(
            'number',
						...
						foreach($post_terms as $p_term)
							...
							<div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all <?php echo esc_attr($term_slug); ?>">
                                <div class="project-block-two">
                                    <div class="inner-box">
                                        <figure class="image-box"><a href="<?php echo esc_url($post_thumbnail_url); ?>" class="lightbox-image" data-fancybox="gallery"><?php the_post_thumbnail('kodesk_400x360'); ?></a></figure>
                                    </div>
                                </div>
                            </div>
