...
class Faqs extends Widget_Base {
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'search_tab',
            [
                'label' => esc_html__('Search', 'kodesk'),
            ]
        );
        $this->add_control(
            'title',
		...
		$this->add_control(
            'bottom_text',
            [
                'label'       => esc_html__('Bottom Text', 'kodesk'),
                'type'        => Controls_Manager::TEXTAREA,
                'dynamic'     => [
                    'active' => true,
                ],
    ...
    protected function render() {
        ...
        $this->add_render_attribute('wrapper', 'class', 'themerange-kodesk');
        $args = array(
            'post_type'      => 'faqs',
        ...
        if( kodesk_set($settings, 'query_category') ) $args['faqs_cat'] = kodesk_set($settings, 'query_category');
            ...
            <div class="auto-container">
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                        <div class="default-sidebar faq-sidebar">
                                    ...
                                    <div class="search-inner">
                                        <form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get" class="search-form">
                                            <div class="form-group">
                                                ...
                                                <input type="search" name="s" placeholder="<?php esc_attr_e('Keyword...', 'kodesk'); ?>">
                            ...
                            <ul class="accordion-box">
                                ...
                                <li class="accordion block <?php if($i == 1) echo 'active-block'; ?>">
                                    <div class="acc-btn <?php if($i == 1) echo 'active'; ?>">
                                        ...
                                        <h4><i class="flaticon-question"></i><?php the_title(); ?></h4>
                                    </div>
