...
class Call_To_Action extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Call To Action', 'kodesk' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'call_to_action',
            [
                'label' => esc_html__( 'Call to Action', 'kodesk' ),
            ]
        );
        $this->add_control(
            'bg_image',
                ...
                <div class="auto-container">
                    <div class="inner-box">
                        ...
                        <div class="btn-box">
                            ...
                            <a href="tel:<?php echo esc_attr(phone_number($settings['phone_number'])); ?>" class="phone theme-btn"><i class="flaticon-phone"></i><?php echo wp_kses( $settings['phone_number'], true ); ?></a>
                            <?php } ?>
