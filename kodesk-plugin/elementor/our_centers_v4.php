 ...
 * @since 1.0.0
 */
class Our_Centers_V4 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Centers V4', 'kodesk' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_centers_v4',
			[
				'label' => esc_html__( 'Our Centers V4', 'kodesk' ),
			]
		);
		$this->add_control(
			'subtitle',
	 ...
	 */
	 protected function render() {
        ...
        <section class="ourcenters-style-two locations-page-2 centred">
