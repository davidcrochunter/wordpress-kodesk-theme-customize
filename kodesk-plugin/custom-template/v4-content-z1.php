<div class="col-lg-12 col-md-12 col-sm-12 workspaces-block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <ul class="feature-list clearfix" >
                                <?php if (get_post_meta( get_the_id(), 'users', true )){ ?>
                                    <li>
                                        <a href="<?php echo esc_url(get_post_meta( get_the_id(), 'ext_url', true )); ?>"><i class="fas fa-angle-right"></i></a>
