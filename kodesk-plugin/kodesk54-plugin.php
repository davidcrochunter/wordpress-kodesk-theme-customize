...
function register_script() {
	...
	// wp_register_script('v4_detail_email_contact', 'https://cdn.jsdelivr.net/npm/@emailjs/browser@3/dist/email.min.js');
...
function enqueue_style(){
	...
	// wp_enqueue_script('v4_detail_email_contact');
