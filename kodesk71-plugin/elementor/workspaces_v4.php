...
class Workspaces_V4 extends Widget_Base {
    ...
    protected function render() {
        ...
        if( $addcondition_cat ) {
            ...
            $delimiter = ",";
            $addcondition_cat_arr = explode($delimiter, $addcondition_cat);


            array_push($tax_query, array(
                'taxonomy' => 'addcondition_cat',
                'field' => 'slug',
                'terms' => $addcondition_cat_arr,
                'operator'  => 'IN',
            ));
        }
        if( !empty($tax_query) ) {
        ...
        include_once(ABSPATH . 'wp-content/plugins/kodesk71-plugin/custom-template/v4-filter.php');
            ...
            <section class="workspaces-page-section" data-workspace-cat="<?php echo $args['workspace_cat'] ?>">
                ...
                <div class="auto-container">
                    <div class="row clearfix">
                            ...
                            <div class="workspaces-content-side">
                                <div class="row clearfix">
                                    ...
                                    while ( /*$query->*/have_posts() ) : /*$query->*/the_post(); ?>
                                        <?php include(ABSPATH . 'wp-content/plugins/kodesk71-plugin/custom-template/v4-content.php'); ?>
                                    <?php endwhile; ?>
                                </div>

                                <?php 
                                    if($total_post > 4) {
                                        include_once(ABSPATH . 'wp-content/plugins/kodesk71-plugin/custom-template/v4-pagination.php'); 
                                    }
                                ?>
                        ...
                        <?php include_once(ABSPATH . 'wp-content/plugins/kodesk71-plugin/custom-template/v4-map.php'); ?>
