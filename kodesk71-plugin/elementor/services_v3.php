...
class Services_V3 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Services V3', 'kodesk' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'services_v3',
            [
                'label' => esc_html__( 'Services V3', 'kodesk' ),
            ]
        );
        $this->add_control(
            'subtitle',
                        ...
                        <div class="service-block-two">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="shape" style="background-image: url(<?php echo esc_url(get_template_directory_uri().'/assets/images/shape/shape-21.png'); ?>);"></div>
