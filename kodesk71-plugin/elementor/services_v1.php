...
class Services_V1 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Services V1', 'kodesk' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'services_v1',
            [
                'label' => esc_html__( 'Services V1', 'kodesk' ),
            ]
        );
        $this->add_control(
            'subtitle',
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                	<?php $image = get_post_meta( get_the_id(), 'featured_image', true );
									$image_hover = get_post_meta( get_the_id(), 'featured_image_hover', true ); ?>
                                    <figure class="image"><img src="<?php echo esc_url(wp_get_attachment_url($image['id']));?>" alt="<?php esc_attr_e('Icon Image', 'kodesk'); ?>"></figure>
                                    <figure class="overlay-image"><img src="<?php echo esc_url(wp_get_attachment_url($image_hover['id']));?>" alt="<?php esc_attr_e('Icon Image', 'kodesk'); ?>"></figure>
                                </div>
                                <div class="lower-content">
                                    <h6><?php echo wp_kses(get_post_meta( get_the_id(), 'post_subtitle', true ), true); ?></h6>
                                    ...
                                    <div class="btn-box">
                                        <a href="<?php echo esc_url(get_post_meta( get_the_id(), 'ext_url', true )); ?>" class="theme-btn btn-two"><span><?php esc_html_e('Find Spaces', 'kodesk'); ?></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
