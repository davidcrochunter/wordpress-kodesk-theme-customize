...
use KODESK\Includes\Classes\Header_Enqueue;
use KODESK\Includes\Classes\Options;
...
class Base {
	...
	public static function instance() {
		...
		if ( isset( $GLOBALS['kodesk_base'] ) ) {
			return $GLOBALS['kodesk_base'];
		}
	...
	function option( $key = '' ) {
		...
		$options = (array) get_theme_mod( 'kodesk' . '_options-mods' );

		$dn = kodesk_dot( $options );
