...
class Options {
	 ...
	 * @var string
	 */
	private $opt_name = 'kodesk' . '_options';
	...
	private $page_slug = 'kodesk' . '_options';
	...
	function init() {
		...
		$this->menu_title = esc_html__( 'KODESK Options', 'kodesk' );
		$this->page_title = esc_html__( 'KODESK Options', 'kodesk' );
	...
	function args() {
		...
		$args = array(
			...
			'global_variable'      => 'kodesk_options',
	...
	function helpTabs() {
		...
		$tabs = array(
			array(
				'id'      => 'redux-help-tab-1',
				'title'   => esc_html__( 'Theme Information 1', 'kodesk' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'kodesk' ),
			),
			array(
				'id'      => 'redux-help-tab-2',
				'title'   => esc_html__( 'Theme Information 2', 'kodesk' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'kodesk' ),
			),
		);
		...
		$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'kodesk' ) . '</p>';
	...
	function sections() {
		...
		$sections_path = apply_filters( 'kodesk_redux_sections', $sections_path );
		...
		foreach ( $sections_path as $key => $file ) {
			...
			if ( file_exists( $file ) ) {
				...
				$options = apply_filters( "kodesk_redux_sections_{$key}", $options );
