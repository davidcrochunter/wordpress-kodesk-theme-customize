...
//Light Logo
$light_logo = $options->get( 'light_logo_v2' );
$light_logo_dimension = $options->get( 'light_logo_dimension_v2' );

//Dark Logo
$dark_logo = $options->get( 'dark_logo_v2' );
$dark_logo_dimension = $options->get( 'dark_logo_dimension_v2' );
...
<div class="boxed_wrapper home-2">
    ...
    <header class="main-header header-style-two">
        ...
        <div class="header-lower">
            <div class="outer-box">
            	<?php if( $options->get('show_sidebar_info_v2') ) { ?>
                <!--Mobile Navigation Toggler-->
                <div class="mobile-nav-toggler">
                    <div class="menu-icon"><img src="<?php echo esc_url(get_template_directory_uri().'/assets/images/icons/menu-icon-2.png'); ?>" alt="<?php esc_attr_e('icon', 'kodesk'); ?>"></div>
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            ...
            <div class="contact-info">
                <h4><?php echo wp_kses($options->get('sidebar_contact_title_v2'), $allowed_html); ?></h4>
                <ul>
                	<?php if( $options->get('sidebar_address_v2') ) { ?>
                    <li><?php echo wp_kses($options->get('sidebar_address_v2'), $allowed_html); ?></li>
                    <?php } ?>
                    
                    <?php if( $options->get('sidebar_phone_number_v2') ) { ?>
                    <li><a href="tel:<?php echo esc_attr(phone_number($options->get('sidebar_phone_number_v2'))); ?>"><?php echo wp_kses($options->get('sidebar_phone_number_v2'), $allowed_html); ?></a></li>
                    <?php } ?>
                    
                    <?php if( $options->get('sidebar_email_address_v2') ) { ?>
                    <li><a href="mailto:<?php echo sanitize_email($options->get('sidebar_email_address_v2')); ?>"><?php echo sanitize_email($options->get('sidebar_email_address_v2')); ?></a></li>
                    <?php } ?>
                </ul>
            </div>
            
            <?php if( $options->get('show_sidebar_social_media_v2') ):
			$icons = $options->get( 'sidebar_social_media_v2' );
			if ( ! empty( $icons ) ) : ?>
