...
class Workspaces_V4 extends Widget_Base {
    ...
    protected function render() {
        ...
        include_once(ABSPATH . 'wp-content/plugins/kodesk34-plugin/custom-template/v4-filter.php');
            ...
            <section class="workspaces-page-section" data-workspace-cat="<?php echo $args['workspace_cat'] ?>">
                <div class="auto-container">
                    <div class="row clearfix">
                            ...
                            <div class="workspaces-content-side">
                                <div class="row clearfix">
                                    ...
                                    while ( /*$query->*/have_posts() ) : /*$query->*/the_post(); ?>
                                        <?php include(ABSPATH . 'wp-content/plugins/kodesk34-plugin/custom-template/v4-content.php'); ?>
                                    <?php endwhile; ?>
                                </div>
                                
                                <?php include_once(ABSPATH . 'wp-content/plugins/kodesk34-plugin/custom-template/v4-pagination.php'); ?>
                        ...
                        <?php include_once(ABSPATH . 'wp-content/plugins/kodesk34-plugin/custom-template/v4-map.php'); ?>
