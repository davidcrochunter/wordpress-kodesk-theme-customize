 ...
 * @since 1.0.0
 */
class Pricing_Plan_V1 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Pricing Plan V1', 'kodesk' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'pricing_plan_v1',
            [
                'label' => esc_html__( 'Pricing Plan V1', 'kodesk' ),
            ]
        );
		$this->add_control(
            'show_background',
            [
                'label'     => esc_html__('Show / Hide Background Shape', 'kodesk'),
    ...
    protected function render() {
        ...
        <section class="pricing-section sec-pad">
        	<?php if ($settings['show_background'] == 'yes'){ ?>
            ...
            <div class="auto-container">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pricing-block">
                        <div class="pricing-block-one <?php if($item['features_plan'] == 'yes') echo 'active-block'; ?> wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="pricing-table">
                                <div class="table-header">
                                    <?php if ($item['price']){ ?><h3><?php echo wp_kses($item['price'], $allowed_tags); ?></h3><?php } ?>
                                ...
                                <div class="feature-box">
                                    ...
                                    <div class="single-item"><?php echo wp_kses($features, true); ?></div>
                                    <?php endforeach; ?>
                                </div>
                                <?php } ?>
