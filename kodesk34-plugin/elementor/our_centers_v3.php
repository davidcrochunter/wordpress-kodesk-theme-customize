 ...
 * @since 1.0.0
 */
class Our_Centers_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Centers V3', 'kodesk' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_centers_v3',
			[
				'label' => esc_html__( 'Our Centers V3', 'kodesk' ),
			]
		);
		$this->add_control(
			'subtitle',
	 ...
	 */
	 protected function render() {
		...
		<!-- ourcenters-section -->
        <section class="ourcenters-section locations-page-1">
