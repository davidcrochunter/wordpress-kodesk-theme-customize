                        ...
                        <div class="workspaces-content-side">
                            <div class="row clearfix">
                                ...
                                while ( /*$query->*/have_posts() ) : /*$query->*/the_post(); ?>
                                    <?php include(ABSPATH . 'wp-content/plugins/kodesk71-plugin/custom-template/v4-detail-related.php'); ?>
                                <?php endwhile; ?>
                            </div>
                        </div>
                    </div>
        ...
        <div class="auto-container">
            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 content-side">
                    <?php 
                    get_template_part( 'template-parts/v4-detail-contuct' );
                    ?>
                </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 sidebar-side v4-detail-map">
                    <div id="v4-detail-latlng-names" style="display: none">
        	...
        	<div class="row clearfix vc-det-nxt-prv-btn-padding">
