...
class Events_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Events V2', 'kodesk' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'events_v2',
			[
				'label' => esc_html__( 'Events V2', 'kodesk' ),
			]
		);
		$this->add_control(
              'event_tab', 
	 ...
	 */
	 protected function render() {
		...
		<!-- events-section -->
        <section class="events-section events-page-one">
                ...
                <div class="inner-content tabs-box">
                    <div class="upper-box clearfix centred">
                        <ul class="tab-btns list tab-buttons clearfix p_relative d_iblock">
							...
							<li class="tab-btn <?php if($i == 1) echo 'active-btn'; ?>" data-tab="#tab-<?php echo esc_attr($i); ?>"><?php echo wp_kses($item['block_title'], true); ?></li>
							<?php $i++; endforeach; ?>
                        </ul>
                    </div>
