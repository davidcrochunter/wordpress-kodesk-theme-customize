...
class Testimonials_V2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Testimonials V2', 'kodesk' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'testimonials_v2',
            [
                'label' => esc_html__( 'Testimonials V2', 'kodesk' ),
            ]
        );
		$this->add_control(
            'bg_image',
                ...
                <div class="auto-container">
                    <div class="single-item-carousel owl-carousel owl-theme owl-nav-none dots-style-one">
                        ...
                        <div class="content-box">
                            <div class="quote"><img src="<?php echo esc_url(get_template_directory_uri().'/assets/images/icons/quote-4.png'); ?>" alt="<?php esc_attr_e('Quote Icon', 'kodesk'); ?>"></div>
                            <div class="text mw-67 m-auto">
                                <p><?php echo wp_kses(kodesk_trim(get_the_content(), $settings['text_limit']), true); ?></p>
                                <h3><?php the_title(); ?>, <span><?php echo get_post_meta( get_the_id(), 'designation', true ); ?></span></h3>
